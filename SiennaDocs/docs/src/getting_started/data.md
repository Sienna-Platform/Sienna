...
| Build your own data set | [Parse a MATPOWER or PSS/e file](@extref PowerSystems pm_data) or [Build a `System` from .csv Files](@extref PowerSystems system_from_csv) | [PowerSystems.jl](@extref PowerSystems :doc:`index`) |
| Add other data as needed | `PowerSystems.jl` "How to..." pages, on e.g., [cost](@extref PowerSystems cost_how_to), [outage](@extref PowerSystems model_outages), and [emissions](@extref PowerSystems add_emissions_to_generators) data | [PowerSystems.jl](@extref PowerSystems :doc:`index`) |
